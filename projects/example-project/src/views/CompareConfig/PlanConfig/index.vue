...
import { queryBdfaList, addOrUpdateSjdx, delSjdx } from "@/api/bdfa"
...
export default {
  ...
  methods: {
    ...
    async getData() {
      let params = {
        famc: this.filters.famc,
        pageNum: this.page_index,
        pageSize: this.page_size
      }
      const res = await queryBdfaList(params)
